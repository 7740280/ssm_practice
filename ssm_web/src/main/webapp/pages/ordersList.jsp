...
<head>
    ...
    <!--<link rel="stylesheet" href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/${pageContext.request.contextPath}/static/plugins/timepicker/bootstrap-timepicker.min.css">-->
    ...
    <!-- bootstrap color picker -->
    <!-- bootstrap time picker -->
    <!--<script src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/${pageContext.request.contextPath}/static/plugins/timepicker/bootstrap-timepicker.min.js"></script>-->
    <!-- Bootstrap WYSIHTML5 -->
    <!--bootstrap-markdown-->
    <!-- CK Editor -->
    <!-- InputMask -->
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">支付渠道</th>
